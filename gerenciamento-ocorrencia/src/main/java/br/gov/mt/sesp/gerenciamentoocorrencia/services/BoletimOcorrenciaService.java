...
import br.gov.mt.sesp.gerenciamentoocorrencia.dtos.*;
...
import static br.gov.mt.sesp.gerenciamentoocorrencia.models.BoletimOcorrencia.SituacaoBoletimOcorrencia.*;
...
public class BoletimOcorrenciaService {
     ...
     */
    public BoletimOcorrenciaDTO salvar(BoletimOcorrenciaSaveDTO boletimOcorrenciaSaveDTO) {
     ...
     */
    public BoletimOcorrenciaDTO buscar(Long id) {
        BoletimOcorrencia boletimOcorrencia = boletimOcorrenciaRepository
                .findById(id)
     ...
     */
    private BoletimOcorrenciaDTO construirDTO(BoletimOcorrencia boletimOcorrencia) {
